...
class ConfigureFlinkLibAction : AnAction() {

    init {
        templatePresentation.text = "Configure Flink Lib Directory"
    }
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val descriptor = FileChooserDescriptor(false, true, false, false, false, false).apply {
            title = "Select Flink Lib Directory"
            description = "Choose the directory containing Flink JAR files"
        }
        ...
        if (chosenFiles.isNotEmpty()) {
            ...
            Messages.showInfoMessage(
                project,
                "Flink Lib directory set to: ${selectedDir.path}",
                "Flink Lib Directory Configured"
            )
        }
    }
}